# Contributing to @lumina-study/services-status
...
- `pnpm dev` - Build in watch mode (not implemented yet, but available in most setups)
- `pnpm test` - Run tests
- `pnpm test:watch` - Test watch mode
- `pnpm test:coverage` - Run tests with coverage (add to package.json if needed)
...
- **eslint-config-publishable-package-json** for package.json validation
